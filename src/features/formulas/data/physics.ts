      ...
      subtopics: [
        {
          ...
          formulas: [
            ...
            },
            {
              ...
              latex: 'P = m \\cdot g',
              description:
                'Сила тяжіння — сила, з якою Земля притягує тіло. Прискорення вільного падіння g ≈ 9.81 м/с².',
              descriptionEn:
                'Weight is the gravitational force acting on an object. The acceleration due to gravity g ≈ 9.81 m/s².',
              variables: [
                {
                  symbol: 'P',
                  name: 'Сила тяжіння',
                ...
                },
                {
                  ...
                  nameEn: 'Gravitational acceleration',
                  unit: 'м/с² (m/s²)',
                  type: 'input',
                  defaultValue: 9.81
                }
            ...
            },
            {
              ...
              descriptionEn:
                'Momentum is the product of mass and velocity. It characterizes the quantity of motion.',
              variables: [
                {
                  symbol: 'p',
                  name: 'Імпульс',
          ...
          formulas: [
            {
              ...
              descriptionEn:
                'Kinetic energy is the energy of motion. It depends on mass and the square of velocity.',
              variables: [
                {
                  symbol: 'E_k',
                  name: 'Кінетична енергія',
          ...
          formulas: [
            {
              ...
              latex: 'I = \\frac{U}{R}',
              description:
                'Закон Ома для ділянки кола: сила струму прямо пропорційна напрузі та обернено пропорційна опору.',
              descriptionEn:
            ...
            },
            {
              ...
              latex: 'P = U \\cdot I',
              description:
                'Потужність електричного струму — робота, яку виконує струм за одиницю часу.',
              descriptionEn:
                'Electric power is the work done by the electric current per unit of time.',
              variables: [
                {
                  symbol: 'P',
                  name: 'Потужність',
          ...
          formulas: [
            {
              ...
              description:
                'Кількість теплоти, необхідна для нагрівання тіла, залежить від питомої теплоємності речовини, маси тіла та зміни температури.',
              descriptionEn:
                'The amount of heat required to warm a body depends on the specific heat capacity, mass, and temperature change.',
              variables: [
                {
                  symbol: 'Q',
                  name: 'Кількість теплоти',
            ...
            },
            {
              ...
              latex: 'Q = L \\cdot m',
              description:
                'Кількість теплоти при фазовому переході (плавлення, кипіння) дорівнює добутку питомої теплоти переходу на масу речовини.',
              descriptionEn:
                'Heat during phase change (melting, boiling) equals the product of specific latent heat and mass.',
              variables: [
                {
                  symbol: 'Q',
                  name: 'Кількість теплоти',
                ...
                {
                  symbol: 'L',
                  name: 'Питома теплота переходу',
                  nameEn: 'Specific latent heat',
                  unit: 'Дж/кг (J/kg)',
                  type: 'input'
                },
                {
          ...
          formulas: [
            {
              ...
              description:
                'Коефіцієнт корисної дії теплового двигуна — відношення виконаної роботи до отриманої теплоти, виражене у відсотках.',
              descriptionEn:
              ...
              variables: [
                ...
                {
                  symbol: 'Q_1',
                  name: 'Отримана теплота',
                  nameEn: 'Heat received',
                  unit: 'Дж (J)',
                  type: 'input'
                }
              ],
            ...
            },
            {
              ...
              description:
                'Максимально можливий ККД теплового двигуна, що працює між двома температурами. T₁ — температура нагрівача, T₂ — температура холодильника.',
              descriptionEn:
                'Maximum possible efficiency of a heat engine operating between two temperatures. T₁ = hot reservoir, T₂ = cold reservoir.',
              variables: [
                {
                  symbol: 'η',
                  name: 'ККД Карно',
                ...
                {
                  symbol: 'T_1',
                  name: 'Температура нагрівача',
                  nameEn: 'Hot reservoir temperature',
                  unit: 'К (K)',
                  type: 'input'
                },
                {
                  symbol: 'T_2',
                  name: 'Температура холодильника',
                  nameEn: 'Cold reservoir temperature',
                  unit: 'К (K)',
                  type: 'input'
                }
              ],
          ...
          formulas: [
            {
              ...
              description:
                'Закон заломлення світла: добуток показника заломлення середовища на синус кута падіння дорівнює аналогічному добутку для заломленого променя.',
              descriptionEn:
                "Snell's law of refraction: the product of the refractive index and sine of the angle of incidence equals that for the refracted ray.",
              variables: [
                {
                  symbol: 'θ₂',
                  name: 'Кут заломлення',
                ...
                {
                  symbol: 'n₁',
                  name: 'Показник заломлення 1',
                  nameEn: 'Refractive index 1',
                  unit: '',
                  type: 'input',
                  defaultValue: 1
                },
                ...
                {
                  symbol: 'n₂',
                  name: 'Показник заломлення 2',
                  nameEn: 'Refractive index 2',
                  unit: '',
                  type: 'input'
                }
              ],
            ...
            },
            {
              ...
              description:
                "Зв'язує фокусну відстань лінзи з відстанню від предмета до лінзи та від лінзи до зображення.",
              descriptionEn:
                'Relates the focal length of a lens to the object distance and image distance.',
              variables: [
                {
                  symbol: 'f',
                  name: 'Фокусна відстань',
                  nameEn: 'Focal length',
                  unit: 'м (m)',
                  type: 'result'
                },
            ...
            },
            {
              ...
              latex: "M = \\frac{d'}{d}",
              description:
                'Лінійне збільшення лінзи — відношення відстані до зображення до відстані до предмета.',
              descriptionEn:
                'Linear magnification is the ratio of image distance to object distance.',
              variables: [
                {
                  symbol: 'M',
                  name: 'Збільшення',
      ...
      subtopics: [
        {
          ...
          formulas: [
            ...
            },
            {
              ...
              latex: 'T = \\frac{1}{f}',
              description:
                'Період коливань — час одного повного коливання. Обернено пропорційний частоті.',
              descriptionEn:
            ...
            },
            {
              ...
              description:
                'Період коливань математичного маятника залежить лише від довжини нитки та прискорення вільного падіння.',
              descriptionEn:
          ...
          formulas: [
            {
              ...
              description:
                'Сила гравітаційного притягання між двома тілами пропорційна добутку їх мас та обернено пропорційна квадрату відстані. G = 6.674×10⁻¹¹.',
              descriptionEn:
                'Gravitational force between two bodies is proportional to the product of their masses and inversely proportional to the square of distance. G = 6.674×10⁻¹¹.',
              variables: [
                {
                  symbol: 'F',
                  name: 'Сила тяжіння',
              ...
              resultVar: 'F',
              derivedFormulas: ['phys_orbital_v', 'phys_escape_v'],
              topic: 'Гравітація',
              subtopic: 'Закон всесвітнього тяжіння'
            },
            {
              id: 'phys_orbital_v',
              ...
              variables: [
                ...
                },
                {
                  ...
                  unit: 'м',
                  type: 'input',
                  defaultValue: 6.371e6
                }
              ],
              compute: (v) => Math.sqrt((v.G * v.M) / v.R),
              resultVar: 'v₁',
              derivedFormulas: ['phys_escape_v', 'phys_gravity_law'],
              topic: 'Гравітація',
              subtopic: 'Закон всесвітнього тяжіння'
            },
            {
              ...
              description:
                'Мінімальна швидкість для подолання гравітаційного поля планети. Для Землі ≈ 11.2 км/с.',
              descriptionEn:
                "Minimum speed to escape a planet's gravitational field. For Earth ≈ 11.2 km/s.",
              variables: [
                {
                  symbol: 'v₂',
                  name: 'Швидкість втечі',
                  nameEn: 'Escape velocity',
                  unit: 'м/с',
                  type: 'result'
                },
              ...
              resultVar: 'v₂',
              derivedFormulas: ['phys_orbital_v', 'phys_gravity_law'],
              topic: 'Гравітація',
              subtopic: 'Закон всесвітнього тяжіння'
            }
          ]
          ...
          formulas: [
            {
              ...
              latex: 'E = mc^2',
              description:
                'Знаменита формула Ейнштейна: енергія дорівнює масі, помноженій на квадрат швидкості світла.',
              descriptionEn:
              ...
              resultVar: 'E',
              derivedFormulas: ['phys_radioactive_decay'],
              topic: 'Ядерна фізика',
              subtopic: 'Радіоактивність'
            },
            {
              ...
              description:
                'Кількість нерозпалих ядер зменшується експоненційно. T₁/₂ — період напіврозпаду.',
              descriptionEn:
                'The number of undecayed nuclei decreases exponentially. T₁/₂ — half-life.',
              variables: [
                {
                  symbol: 'N',
                  name: 'Кількість ядер',
                  nameEn: 'Remaining nuclei',
                  unit: '',
                  type: 'result'
                },
                {
                  symbol: 'N₀',
                  name: 'Початкова кількість',
                  nameEn: 'Initial nuclei',
                  unit: '',
                  type: 'input'
                },
                {
              ...
              resultVar: 'N',
              derivedFormulas: ['phys_mass_energy'],
              topic: 'Ядерна фізика',
              subtopic: 'Радіоактивність'
            },
            {
              ...
              description:
                'Енергія фотона пропорційна частоті випромінювання. h = 6.626×10⁻³⁴ Дж·с — стала Планка.',
              descriptionEn:
                'Photon energy is proportional to radiation frequency. h = 6.626×10⁻³⁴ J·s — Planck constant.',
              variables: [
                {
                  symbol: 'E',
                  name: 'Енергія фотона',
              ...
              compute: (v) => v.h * v.f,
              resultVar: 'E',
              derivedFormulas: ['phys_mass_energy', 'phys_wave_speed'],
              topic: 'Ядерна фізика',
              subtopic: 'Радіоактивність'
            }
          ]
          ...
          formulas: [
            {
              ...
              description:
                'Закон збереження енергії для потоку ідеальної рідини: сума тиску, кінетичної та потенціальної енергії є сталою.',
              descriptionEn:
              ...
              variables: [
                ...
                {
                  symbol: 'v',
                  name: 'Швидкість потоку',
                  nameEn: 'Flow velocity',
                  unit: 'м/с',
                  type: 'input'
                },
                {
            ...
            },
            {
              ...
              description:
                'Виштовхувальна сила, що діє на тіло, занурене в рідину, дорівнює вазі витісненої рідини.',
              descriptionEn:
                'The buoyant force on an object submerged in fluid equals the weight of displaced fluid.',
              variables: [
                {
                  symbol: 'F_a',
                  name: 'Сила Архімеда',
              ...
              resultVar: 'F_a',
              derivedFormulas: ['phys_bernoulli'],
              topic: 'Механіка рідин',
              subtopic: 'Гідростатика'
            },
            {
              ...
              description:
                "Об'ємна витрата рідини залишається сталою: при звуженні труби швидкість потоку зростає.",
              descriptionEn:
                'Volume flow rate remains constant: when a pipe narrows, flow velocity increases.',
              variables: [
                {
                  symbol: 'A₁',
                  name: 'Площа перерізу 1',
                  nameEn: 'Cross-section area 1',
                  unit: 'м²',
                  type: 'input'
                },
                {
                ...
                {
                  symbol: 'A₂',
                  name: 'Площа перерізу 2',
                  nameEn: 'Cross-section area 2',
                  unit: 'м²',
                  type: 'input'
                },
                {
          ...
          formulas: [
            {
              ...
              description:
                'Швидкість світла у вакуумі визначається магнітною та електричною сталими.',
              descriptionEn:
                'Speed of light in vacuum is determined by magnetic and electric constants.',
              variables: [
                {
                  symbol: 'c',
                  name: 'Швидкість світла',
                ...
                },
                {
                  symbol: 'μ₀',
                  name: 'Магнітна стала',
                  nameEn: 'Magnetic constant',
                  unit: 'Гн/м',
                  type: 'input',
                  defaultValue: 1.2566e-6
                },
                {
                  symbol: 'ε₀',
                  name: 'Електрична стала',
                  nameEn: 'Electric constant',
                  unit: 'Ф/м',
                  type: 'input',
                  defaultValue: 8.854e-12
                }
              ],
              compute: (v) => 1 / Math.sqrt(v['μ₀'] * v['ε₀']),
              resultVar: 'c',
              derivedFormulas: ['phys_photon_energy'],
            ...
            },
            {
              ...
              variables: [
                ...
                {
                  symbol: 'f',
                  name: 'Частота джерела',
                  nameEn: 'Source frequency',
                  unit: 'Гц',
                  type: 'input'
                },
                {
                ...
                {
                  symbol: 'v_o',
                  name: 'Швидкість спостерігача',
                  nameEn: 'Observer speed',
                  unit: 'м/с',
                  type: 'input',
                  defaultValue: 0
                },
              ...
              resultVar: "f'",
              derivedFormulas: ['phys_wave_speed'],
              topic: 'Електромагнітні хвилі',
              subtopic: 'Властивості хвиль'
            }
          ]
          ...
          formulas: [
            {
              ...
              resultVar: 'τ',
              derivedFormulas: ['phys_moment_inertia'],
              topic: 'Обертальний рух',
              subtopic: 'Основи обертання'
            },
            {
              ...
              description:
                'Кінетична енергія тіла, що обертається, залежить від моменту інерції та кутової швидкості.',
              descriptionEn:
