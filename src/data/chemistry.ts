      ...
      subtopics: [
        {
          ...
          formulas: [
            ...
            },
            {
              ...
              description:
                "При розбавленні розчину добуток концентрації на об'єм залишається незмінним.",
              descriptionEn:
                'When diluting a solution, the product of concentration and volume remains constant.',
              variables: [
                {
                  symbol: 'C_2',
                  name: 'Кінцева концентрація',
            ...
            },
            {
              ...
              descriptionEn:
                'Mass fraction is the ratio of the mass of solute to the total mass of the solution, expressed as a percentage.',
              variables: [
                {
                  symbol: 'w',
                  name: 'Масова частка',
          ...
          formulas: [
            {
              ...
              latex: 'PV = nRT',
              description:
                "Рівняння стану ідеального газу зв'язує тиск, об'єм, кількість речовини та температуру. R = 8.314 Дж/(моль·К).",
              descriptionEn:
            ...
            },
            {
              ...
              latex: 'pH = -\\log[H^+]',
              description:
                "pH — міра кислотності розчину. Визначається як від'ємний десятковий логарифм концентрації іонів водню.",
              descriptionEn:
                'pH is a measure of solution acidity. Defined as the negative base-10 logarithm of hydrogen ion concentration.',
              variables: [
                {
                  symbol: 'pH',
                  name: 'Водневий показник',
                  nameEn: 'pH value',
                  unit: '',
                  type: 'result'
                },
          ...
          formulas: [
            {
              ...
              description:
                'Швидкість реакції визначається як зміна концентрації реагенту або продукту за одиницю часу.',
              descriptionEn:
                'Reaction rate is defined as the change in concentration of reactant or product per unit time.',
              variables: [
                {
                  symbol: 'v',
                ...
                {
                  symbol: 'ΔC',
                  name: 'Зміна концентрації',
                  nameEn: 'Concentration change',
                  unit: 'моль/л (mol/L)',
                  type: 'input'
                },
                {
            ...
            },
            {
              ...
              description:
                'При підвищенні температури на кожні 10°C швидкість реакції зростає у γ разів (γ = 2-4).',
              descriptionEn:
                'For every 10°C temperature increase, reaction rate increases by a factor of γ (γ = 2-4).',
              variables: [
                {
                  symbol: 'v₂',
                  name: 'Нова швидкість',
                ...
                {
                  symbol: 'γ',
                  name: 'Коефіцієнт Вант-Гоффа',
                  nameEn: "Van 't Hoff coefficient",
                  unit: '',
                  type: 'input',
                  defaultValue: 2
                },
                {
                  symbol: 't₁',
                  name: 'Початкова температура',
                  nameEn: 'Initial temperature',
                  unit: '°C',
                  type: 'input'
                },
                {
                  symbol: 't₂',
                  name: 'Кінцева температура',
                  nameEn: 'Final temperature',
                  unit: '°C',
                  type: 'input'
                }
              ],
          ...
          formulas: [
            {
              ...
              description:
                'Константа рівноваги — відношення добутку концентрацій продуктів до добутку концентрацій реагентів у степенях їхніх стехіометричних коефіцієнтів.',
              descriptionEn:
                'The equilibrium constant is the ratio of products of product concentrations to reactant concentrations raised to their stoichiometric coefficients.',
              variables: [
                {
                  symbol: 'K_c',
                  name: 'Константа рівноваги',
                ...
                {
                  symbol: '[C]',
                  name: 'Концентрація продукту C',
                  nameEn: 'Product C concentration',
                  unit: 'моль/л',
                  type: 'input'
                },
                {
                  symbol: '[D]',
                  name: 'Концентрація продукту D',
                  nameEn: 'Product D concentration',
                  unit: 'моль/л',
                  type: 'input'
                },
                {
                  symbol: '[A]',
                  name: 'Концентрація реагенту A',
                  nameEn: 'Reactant A concentration',
                  unit: 'моль/л',
                  type: 'input'
                },
                {
                  symbol: '[B]',
                  name: 'Концентрація реагенту B',
                  nameEn: 'Reactant B concentration',
                  unit: 'моль/л',
                  type: 'input'
                }
              ],
          ...
          formulas: [
            {
              ...
              description:
                'Маса речовини, виділеної при електролізі, пропорційна силі струму та часу. F = 96485 Кл/моль — стала Фарадея.',
              descriptionEn:
                'Mass deposited during electrolysis is proportional to current and time. F = 96485 C/mol — Faraday constant.',
              variables: [
                {
                  symbol: 'm',
                  name: 'Маса речовини',
                  nameEn: 'Mass deposited',
                  unit: 'г (g)',
                  type: 'result'
                },
                {
            ...
            },
            {
              ...
              description:
                'Рівняння Нернста описує залежність електродного потенціалу від концентрації іонів у розчині.',
              descriptionEn:
                'The Nernst equation describes the dependence of electrode potential on ion concentration.',
              variables: [
                {
                  symbol: 'E',
                  name: 'Потенціал',
                  nameEn: 'Cell potential',
                  unit: 'В (V)',
                  type: 'result'
                },
                {
                  symbol: 'E⁰',
                  name: 'Стандартний потенціал',
                  nameEn: 'Standard potential',
                  unit: 'В (V)',
                  type: 'input'
                },
                {
                ...
                {
                  symbol: 'Q',
                  name: 'Реакційна частка',
                  nameEn: 'Reaction quotient',
                  unit: '',
                  type: 'input'
                }
              ],
          ...
          formulas: [
            {
              ...
              descriptionEn:
                'Enthalpy change equals the difference between formation enthalpies of products and reactants.',
              variables: [
                {
                  symbol: 'ΔH',
                  name: 'Зміна ентальпії',
                  nameEn: 'Enthalpy change',
                  unit: 'кДж/моль',
                  type: 'result'
                },
                {
                  symbol: 'H_прод',
                  name: 'Σ ентальпій продуктів',
                  nameEn: 'Products enthalpy sum',
                  unit: 'кДж/моль',
                  type: 'input'
                },
                {
                  symbol: 'H_реаг',
                  name: 'Σ ентальпій реагентів',
                  nameEn: 'Reactants enthalpy sum',
                  unit: 'кДж/моль',
                  type: 'input'
                }
              ],
            ...
            },
            {
              ...
              latex: 'Q = q \\cdot m',
              description:
                'Кількість теплоти, що виділяється при повному згорянні речовини, пропорційна масі та питомій теплоті згоряння.',
              descriptionEn:
                'Heat released during complete combustion is proportional to mass and specific heat of combustion.',
              variables: [
                {
                  symbol: 'Q',
                  name: 'Виділена теплота',
                  nameEn: 'Heat released',
                  unit: 'кДж',
                  type: 'result'
                },
                {
                  symbol: 'q',
                  name: 'Питома теплота згоряння',
                  nameEn: 'Specific heat of combustion',
                  unit: 'кДж/кг',
                  type: 'input'
                },
                {
          ...
          formulas: [
            {
              ...
              description:
                'Загальний тиск суміші газів дорівнює сумі парціальних тисків кожного газу.',
              descriptionEn:
              ...
              variables: [
                {
                  symbol: 'P_заг',
                  name: 'Загальний тиск',
                  nameEn: 'Total pressure',
                  unit: 'атм',
                  type: 'result'
                },
                {
                  symbol: 'P₁',
                  name: 'Парціальний тиск 1',
                  nameEn: 'Partial pressure 1',
                  unit: 'атм',
                  type: 'input'
                },
                {
                  symbol: 'P₂',
                  name: 'Парціальний тиск 2',
                  nameEn: 'Partial pressure 2',
                  unit: 'атм',
                  type: 'input'
                },
                {
                  symbol: 'P₃',
                  name: 'Парціальний тиск 3',
                  nameEn: 'Partial pressure 3',
                  unit: 'атм',
                  type: 'input',
                  defaultValue: 0
                }
              ...
              resultVar: 'P_заг',
              derivedFormulas: ['chem_ideal_gas', 'chem_graham'],
              topic: 'Газові закони',
              subtopic: 'Суміші газів'
            },
            {
              id: 'chem_graham',
              ...
              description:
                'Швидкість ефузії газу обернено пропорційна кореню з його молярної маси.',
              descriptionEn:
                'The rate of effusion is inversely proportional to the square root of molar mass.',
              variables: [
                {
                  symbol: 'r₁/r₂',
                  name: 'Відношення швидкостей',
                  nameEn: 'Rate ratio',
                  unit: '',
                  type: 'result'
                },
                {
                  symbol: 'M₁',
                  name: 'Молярна маса газу 1',
                  nameEn: 'Molar mass gas 1',
                  unit: 'г/моль',
                  type: 'input'
                },
                {
                  symbol: 'M₂',
                  name: 'Молярна маса газу 2',
                  nameEn: 'Molar mass gas 2',
                  unit: 'г/моль',
                  type: 'input'
                }
              ],
              ...
              resultVar: 'r₁/r₂',
              derivedFormulas: ['chem_dalton', 'chem_ideal_gas'],
              topic: 'Газові закони',
              subtopic: 'Суміші газів'
            }
          ]
          ...
          formulas: [
            {
              ...
              description:
                "Ступінь ненасиченості (DBE) показує кількість подвійних зв'язків та циклів. C, H, N, X — кількість атомів вуглецю, водню, азоту, галогенів.",
              descriptionEn:
                'Degree of unsaturation (DBE) shows the number of double bonds and rings. C, H, N, X — carbon, hydrogen, nitrogen, halogen atom counts.',
              variables: [
                {
                  symbol: 'DBE',
                  name: 'Ступінь ненасиченості',
                ...
                {
                  symbol: 'X',
                  name: 'Кількість галогенів',
                  nameEn: 'Halogen count',
                  unit: '',
                  type: 'input',
                  defaultValue: 0
                }
              ...
              resultVar: 'DBE',
              derivedFormulas: ['chem_molar_mass'],
              topic: 'Органічна хімія',
              subtopic: 'Основи органіки'
            },
            {
              ...
              description:
                'Масова частка елемента в сполуці: відношення маси атомів елемента до молярної маси сполуки.',
              descriptionEn:
                'Mass percent of an element: ratio of atomic mass contribution to molar mass of compound.',
              variables: [
                {
                  symbol: 'w',
                  name: 'Масова частка',
                ...
                {
                  symbol: 'n',
                  name: 'Кількість атомів',
                  nameEn: 'Number of atoms',
                  unit: '',
                  type: 'input'
                },
                {
                  symbol: 'Aᵣ',
                  name: 'Атомна маса елемента',
                  nameEn: 'Atomic mass',
                  unit: 'г/моль',
                  type: 'input'
                },
                {
                  symbol: 'Mᵣ',
                  name: 'Молярна маса сполуки',
                  nameEn: 'Compound molar mass',
                  unit: 'г/моль',
                  type: 'input'
                }
              ],
              ...
              resultVar: 'w',
              derivedFormulas: ['chem_molar_mass', 'chem_mass_fraction'],
              topic: 'Органічна хімія',
              subtopic: 'Основи органіки'
            },
            {
              ...
              variables: [
                ...
                {
                  symbol: 'm_теор',
                  name: 'Теоретична маса',
                  nameEn: 'Theoretical mass',
                  unit: 'г',
                  type: 'input'
                }
              ],
          ...
          formulas: [
            {
              ...
              description:
                'Осмотичний тиск розчину пропорційний молярній концентрації, температурі та фактору Вант-Гоффа.',
              descriptionEn:
                "Osmotic pressure is proportional to molar concentration, temperature, and van't Hoff factor.",
              variables: [
                {
                  symbol: 'Π',
                  name: 'Осмотичний тиск',
              ...
              resultVar: 'Π',
              derivedFormulas: ['chem_boiling_elevation'],
              topic: 'Колігативні властивості',
              subtopic: 'Властивості розчинів'
            },
            {
              ...
              variables: [
                ...
                {
                  symbol: 'K_b',
                  name: 'Ебуліоскопічна стала',
                  nameEn: 'Ebullioscopic constant',
                  unit: '°C·кг/моль',
                  type: 'input',
                  defaultValue: 0.512
                },
              ...
              resultVar: 'ΔT_b',
              derivedFormulas: ['chem_freezing_depression'],
              topic: 'Колігативні властивості',
              subtopic: 'Властивості розчинів'
            },
            {
              ...
              variables: [
                ...
                {
                  symbol: 'K_f',
                  name: 'Кріоскопічна стала',
                  nameEn: 'Cryoscopic constant',
                  unit: '°C·кг/моль',
                  type: 'input',
                  defaultValue: 1.86
                },
          ...
          formulas: [
            {
              ...
              description:
                'Розраховує pH буферного розчину, знаючи pKa кислоти та співвідношення солі до кислоти.',
              descriptionEn:
                'Calculates pH of a buffer solution knowing the pKa and the ratio of conjugate base to acid.',
              variables: [
                {
                  symbol: 'pH',
                  name: 'Водневий показник',
                ...
                {
                  symbol: '[A⁻]',
                  name: 'Концентрація основи',
                  nameEn: 'Base concentration',
                  unit: 'моль/л',
                  type: 'input'
                },
                {
                  symbol: '[HA]',
                  name: 'Концентрація кислоти',
                  nameEn: 'Acid concentration',
                  unit: 'моль/л',
                  type: 'input'
                }
              ],
              ...
              resultVar: 'pH',
              derivedFormulas: ['chem_ph'],
              topic: 'Аналітична хімія',
              subtopic: 'Кількісний аналіз'
            },
            {
              ...
              description:
                'Масова частка елемента у сполуці: відношення маси атомів елемента до молярної маси сполуки.',
              descriptionEn:
                'Mass fraction of an element: ratio of atomic mass of element to molar mass of compound.',
              variables: [
                {
                  symbol: '%',
                  name: 'Відсотковий склад',
                  nameEn: 'Percent composition',
                  unit: '%',
                  type: 'result'
                },
            ...
            },
            {
              ...
              resultVar: 'V₂',
              derivedFormulas: ['chem_ph', 'chem_henderson'],
              topic: 'Аналітична хімія',
              subtopic: 'Кількісний аналіз'
            },
            {
              ...
              description:
                'Константа добутку розчинності — добуток концентрацій іонів малорозчинної солі.',
              descriptionEn:
                'Solubility product constant is the product of ion concentrations of a sparingly soluble salt.',
              variables: [
                {
                  symbol: 'K_sp',
                  name: 'Добуток розчинності',
                ...
                {
                  symbol: '[A⁺]',
                  name: 'Концентрація катіона',
                  nameEn: 'Cation concentration',
                  unit: 'моль/л',
                  type: 'input'
                },
                {
                  symbol: 'm',
                  name: 'Коефіцієнт катіона',
                  nameEn: 'Cation coefficient',
                  unit: '',
                  type: 'input',
                  defaultValue: 1
                },
                {
                  symbol: '[B⁻]',
                  name: 'Концентрація аніона',
                  nameEn: 'Anion concentration',
                  unit: 'моль/л',
                  type: 'input'
                },
                {
                  symbol: 'n',
                  name: 'Коефіцієнт аніона',
                  nameEn: 'Anion coefficient',
                  unit: '',
                  type: 'input',
                  defaultValue: 1
                }
