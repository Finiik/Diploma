# 🔬 SciLearn — Розробка рекомендаційної системи для підтримки навчання студентів природничих спеціальностей
...
- **Рік:** 2026
- **GitHub:** https://github.com/Finiik/Diploma.git
- **Сайт:** https://scilearn-be957.web.app/
...
![Сторінка формули](screenshots/formula.png)
...
![Search](screenshots/theory.png)

## Задачі

![Recommendations](screenshots/test.png)
